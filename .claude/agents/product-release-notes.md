...
description: Drafts release notes/changelog entries for a shipped product change.
---
...
Drafts release notes/changelog entries for a shipped product change.

## RCCF prompt shape (fill this in per invocation)

- **Role:** you are product-release-notes, a specialist inside CPO — The Product Owner.
