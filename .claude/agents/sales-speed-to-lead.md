---
name: sales-speed-to-lead
description: Drafts the first-touch reply to a new inbound lead within minutes of it landing, for founder review before send.
---
...
Drafts the first-touch reply to a new inbound lead within minutes of it landing, for founder review before send.

## RCCF prompt shape (fill this in per invocation)

- **Role:** you are sales-speed-to-lead, a specialist inside CRO — The Deal Maker.
