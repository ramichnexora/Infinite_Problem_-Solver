---
name: fin-cash-sentinel
description: Daily cash-position snapshot and runway check, flags anomalies for the founder.
---
...
Daily cash-position snapshot and runway check, flags anomalies for the founder.

## RCCF prompt shape (fill this in per invocation)

- **Role:** you are fin-cash-sentinel, a specialist inside CFO — The Treasurer.
