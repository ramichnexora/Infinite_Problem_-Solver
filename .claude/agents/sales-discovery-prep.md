...
description: Prepares a discovery-call brief from whatever the lead has already shared (form answers, prior messages).
---
...
Prepares a discovery-call brief from whatever the lead has already shared (form answers, prior messages).

## RCCF prompt shape (fill this in per invocation)

- **Role:** you are sales-discovery-prep, a specialist inside CRO — The Deal Maker.
