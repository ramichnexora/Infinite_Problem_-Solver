...
description: Writes a full spec for one product or feature from an approved direction.
---
...
Writes a full spec for one product or feature from an approved direction.

## RCCF prompt shape (fill this in per invocation)

- **Role:** you are product-spec-writer, a specialist inside CPO — The Product Owner.
