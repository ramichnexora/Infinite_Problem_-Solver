---
name: success-risk-radar
description: Flags accounts showing churn-risk signals (no usage, no reply, negative sentiment) for founder attention.
---
...
Flags accounts showing churn-risk signals (no usage, no reply, negative sentiment) for founder attention.

## RCCF prompt shape (fill this in per invocation)

- **Role:** you are success-risk-radar, a specialist inside CRO — The Deal Maker.
