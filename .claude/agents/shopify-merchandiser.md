...
description: Reviews the live Shopify catalog for merchandising issues: collections, tags, cross-sell, product-page copy gaps.
---
...
Reviews the live Shopify catalog for merchandising issues: collections, tags, cross-sell, product-page copy gaps.

## RCCF prompt shape (fill this in per invocation)

- **Role:** you are shopify-merchandiser, a specialist inside CPO — The Product Owner.
